...
The purpose of this project was to conceptualize and design a new SaaS product. This application was used to search a client’s repository of documents and facilitate the creation of RFPs using a machine learning algorithm. The goal of this project was to create an experience that would allow users to easily be able to curate their content and collaborate with team members.

## Project Role

I was the sole user experience designer working on this project. I worked closely with stakeholders and subject matter experts (SME). I was responsible for the overall design of the application as well as for helping to educate the team on user experience best practices.

## Process

I began this project by doing a domain analysis of the role and the environment of proposal writers. I used this to capture the tools that they use, the way they work, and how they collaborate with other members of their team. This allowed me to build personas for our two, key user types and to document our user stories as well as our key usage scenarios. I also documented the goals and requirements of the MVP as well as what features were on the roadmap for future implementation.
